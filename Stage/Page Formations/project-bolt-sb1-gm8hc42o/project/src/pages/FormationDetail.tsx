...
const formationsData = {
  ...
  'analyse-dynamique-distanciel': {
    ...
    publicCible: 'Associés ou futurs associés souhaitant mieux se connaître et optimiser leur collaboration.',
    objectifs: [
      'Comprendre les dynamiques comportementales',
      'Analyser les complémentarités entre associés',
      'Utiliser l’outil Intelli7 pour un diagnostic personnalisé'
    ],
    methodologie: [
      'Questionnaire préalable',
      'Atelier interactif en ligne',
      'Analyse personnalisée avec Intelli7',
      'Échanges et retours d’expérience'
    ],
    programme: [
      {
        module: 'Atelier unique',
        duree: '3h30',
        contenu: [
          'Présentation de l’outil Intelli7',
          'Analyse des profils des participants',
          'Lecture des résultats et axes de progrès',
    ...
    evaluation: [
      'Questionnaire préalable',
      'Évaluation orale en fin d’atelier'
    ],
    certification: 'Attestation de participation',
    accessibilite: 'Formation accessible aux personnes en situation de handicap sur demande'
  },
  'analyse-dynamique-presentiel': {
    title: 'Analyse de Dynamique Comportementale',
    subtitle: 'Formation en Présentiel',
  ...
  return (
    <div className="min-h-screen py-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative h-64 rounded-2xl overflow-hidden mb-8">
            ...
            <div className="absolute inset-0 bg-black bg-opacity-40 flex items-end">
              <div className="p-8 text-white">
                ...
                <p className="text-xl text-orange-200">{formation.subtitle}</p>
              </div>
            </div>
          </div>
            ...
            {formation.programme.map((module, index) => (
              <div key={index} className="bg-orange-50 rounded-lg p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="bg-yellow-100 text-orange-800 px-3 py-1 rounded-full text-sm font-medium">
                    {module.duree}
                  </span>
                </div>
        ...
        {/* CTA */}
        <div className="bg-gradient-to-r from-orange-600 to-yellow-500 rounded-2xl p-8 text-center text-white">
