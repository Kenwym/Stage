	...
	return (
		<div className="min-h-screen py-20">
            ...
            Développez vos compétences relationnelles et entrepreneuriales avec nos programmes adaptés à vos besoins.
						...
						>
							...
							<div className="p-6">
								...
								<div className="grid grid-cols-2 gap-4 mb-4">
									...
									<div className="flex items-center text-gray-600">
										<Euro className="w-4 h-4 mr-2 text-orange-500" />
								...
								<Link
									...
									className="inline-flex items-center w-full justify-center px-6 py-3 bg-orange-500 text-white font-semibold rounded-lg hover:bg-orange-600 transition-colors"
								>
									En savoir plus
				...
				{/* Bottom CTA */}
				<div className="mt-16 text-center bg-gradient-to-r from-yellow-50 to-orange-50 rounded-2xl p-8">
